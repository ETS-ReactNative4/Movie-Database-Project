...
public class RedActivity extends ActionBarActivity {
    ...
    public void connectToTomcat(View view) {
        ...
        final StringRequest afterLoginRequest = new StringRequest(Request.Method.GET, "https://ryanpadilla.us:8443/cs122b/login",
        ...
        final StringRequest loginRequest = new StringRequest(Request.Method.POST, "https://ryanpadilla.us:8443/cs122b/login",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("username", "aa@aol.com");
