...
public class RedActivity extends ActionBarActivity {
    ...
    public void connectToTomcat(View view) {
        ...
        final StringRequest afterLoginRequest = new StringRequest(Request.Method.GET, "https://10.0.2.2:8443/cs122b/login",
        ...
        final StringRequest loginRequest = new StringRequest(Request.Method.POST, "https://10.0.2.2:8443/cs122b/login",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
